...
9. **SHIPPED ✓**, then the score sheet. Spend profits in **SHOP UPGRADES** (desk 🏪 or the result sheet) — tools, not pay-to-win. After a handful of good orders a packing video may go **viral**: a 3–5 minute rush queue. Pack fast, but messy boxes still hit rating. **NEXT ORDER** returns to the desk. Pack Score is a weighted mix of Accuracy (25%), Fit (20%), Protection (20%), Cost (15%), and Aesthetic (20%). **98+** is a **PERFECT PACK ✨** (confetti + haptic). Badges: SPACE MASTER, PROTECTOR, BUDGET MASTER, STYLIST, FLAWLESS.
